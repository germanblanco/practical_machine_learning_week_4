...
The best accuracy in the verification dataset is obtained with the Random Forest classifier. The ensemble did not work well in this case, it seems that SVM and KNN agreed in the wrong result quite often, so Random Forest is the best alternative.
